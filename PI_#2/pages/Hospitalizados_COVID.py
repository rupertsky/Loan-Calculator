...
df = pd.read_csv(
    'C:\\Users\\cajas\\PycharmProjects\\PI\\PI_2\\DS-PI-ProyectoIndividual\\COVID-19_Reported_Patient_Impact_and_Hospital_Capacity_by_State_Timeseries.csv')
...
hospt = re_idx_name(hospt, dat_col3, {'state_name': 'Estado', 'total_hospitalized': 'Hospitalizados COVID'})
